...
class PopularDestinationsList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (isLoading) {
      return ListView.builder(
        ...
        padding: const EdgeInsets.symmetric(horizontal: 16),
        itemCount: 5,
        itemBuilder: (context, index) => _buildLoadingDestination(context),
      );
    }
    ...
    if (destinations.isEmpty) {
      return Center(
        child: Column(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
            Icon(Icons.place_outlined, size: 48, color: colorScheme.outline),
            const SizedBox(height: 16),
            Text(
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        return _buildDestinationItem(context, destination, index);
      },
    );
  }
  ...
  Widget _buildLoadingDestination(BuildContext context) {
    final colorScheme = Theme.of(context).colorScheme;
...
class TravelPackagesList extends StatelessWidget {
  ...
  Widget _buildPackageCard(BuildContext context, TravelPackage package) {
    final colorScheme = Theme.of(context).colorScheme;
    final textTheme = Theme.of(context).textTheme;
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      gradient: LinearGradient(
                        ...
                        colors: [
                          package.getGradientStartColor(),
                          package.getGradientEndColor(),
                        ],
                      ),
                    ),
                    child:
